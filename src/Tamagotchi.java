...
public class Tamagotchi {
    public static void main(String[] args) {
    	...
    	Date date = new Date();
    	int second = (int) date.getTime();
    	try {
			PrintWriter pw = new PrintWriter(status);
			pw.println(second);
		} catch (FileNotFoundException e1) {
			e1.printStackTrace();
		}
    	
        JFrame j = new JFrame("Tamagotchi");
        j.add(new Component() {
            ...
            public final Color BACKGROUND_COLOR = new Color(255, 255, 230);
            public final Color PIXEL_COLOR = new Color(10, 12, 60);
            public final Color NONPIXEL_COLOR = new Color(156, 170, 150);
